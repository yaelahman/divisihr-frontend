...
export default {
  ...
  mounted() {
    ...
    this.loadChart2();
    this.checkAbsensi();
    this.checkPersonelSudahAbsen();
    this.checkPersonelBelumAbsen();
    this.checkPersonelWFH();
    this.checkPersonelKunjungan();
    this.checkAkumulasiSuperadmin();
  },
  methods: {
    checkAkumulasiSuperadmin() {
      this.$Progress.start();
      axios
