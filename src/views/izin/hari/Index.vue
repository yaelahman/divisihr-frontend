    ...
    methods: {
        ...
        filterRangeDate() {
            if (this.filterType == 'show') {
                ...
                Swal.fire({
                    title: "Ekspor Izin Hari",
                    text: 'Ingin Ekspor Izin Hari Dengan Tanggal ' + this.search.startDate + ' Sampai ' + this.search.endDate + ' ?',
                    icon: 'warning',
                    ...
                    if (resp.isConfirmed) {
                        window.location.href = `${window.location.origin}/exports/izin/2?start_date=${this.search.startDate}&end_date=${this.search.endDate}&status=${this.search.status}`
                    }
                })
            }
        },
