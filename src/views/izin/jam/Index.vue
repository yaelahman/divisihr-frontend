        ...
        filterRangeDate() {
            if (this.filterType == 'show') {
                ...
                Swal.fire({
                    ...
                    text: 'Ingin Ekspor Izin Jam Dengan Tanggal ' + this.search.startDate + ' Sampai ' + this.search.endDate + ' ?',
                    icon: 'warning',
                    ...
                    if (resp.isConfirmed) {
                        window.location.href = `${window.location.origin}/exports/izin/1?start_date=${this.search.startDate}&end_date=${this.search.endDate}&status=${this.search.status}`
                    }
                })
            }
        },
